    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.sites.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('language_code') ? 'is-invalid' : '' }}" type="text" name="language_code" id="language_code" value="{{ old('language_code', '') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('isdefault') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="isdefault" id="isdefault" value="1" {{ old('isdefault', 0) == 1 ? 'checked' : '' }}>
