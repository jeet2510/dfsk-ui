...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-siteSiteInfos">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.siteInfo.fields.site') }}
                        </th>
                        <th>
...
<script>
  ...
  let table = $('.datatable-siteSiteInfos:not(.ajaxTable)').DataTable({ buttons: dtButtons })
