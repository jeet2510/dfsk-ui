    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.values.update", [$value->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="value_section_id">{{ trans('cruds.value.fields.section') }}</label>
                <select class="form-control select2 {{ $errors->has('section') ? 'is-invalid' : '' }}" name="value_section_id" id="value_section_id" required>
                    @foreach($sections as $id => $entry)
                        <option value="{{ $id }}" {{ (old('section_id') ? old('section_id') : $value->section->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title_1') ? 'is-invalid' : '' }}" type="text" name="title_1" id="title_1" value="{{ old('title_1', $value->title_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title_2') ? 'is-invalid' : '' }}" type="text" name="title_2" id="title_2" value="{{ old('title_2', $value->title_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title_3') ? 'is-invalid' : '' }}" type="text" name="title_3" id="title_3" value="{{ old('title_3', $value->title_3) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('text_1') ? 'is-invalid' : '' }}" name="text_1" id="text_1">{!! old('text_1', $value->text_1) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('text_2') ? 'is-invalid' : '' }}" name="text_2" id="text_2">{!! old('text_2', $value->text_2) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('text_3') ? 'is-invalid' : '' }}" name="text_3" id="text_3">{!! old('text_3', $value->text_3) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_1') ? 'is-invalid' : '' }}" type="text" name="link_1" id="link_1" value="{{ old('link_1', $value->link_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_2') ? 'is-invalid' : '' }}" type="text" name="link_2" id="link_2" value="{{ old('link_2', $value->link_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_3') ? 'is-invalid' : '' }}" type="text" name="link_3" id="link_3" value="{{ old('link_3', $value->link_3) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Value::PUBLISHED_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('published') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="published_{{ $key }}" name="published" value="{{ $key }}" {{ old('published', $value->published) === (string) $key ? 'checked' : '' }}>
