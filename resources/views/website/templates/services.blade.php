...
<section class="services-banner-section">
    <img src="{{ asset('images/services/services-banner.jpg') }}" class="img-fluid" width="100%"/>
</section>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="services-title-div">
                    <h1 class="nouvelr-font">
                        Service
                    </h1>
                    <p>
                        Vehicle Maintenance & OBD Download
                    </p>
                </div>
                    ...
                    <div class="explore-head text-center">
                        <div class="ex-tab-div">
                            ...
                            <ul class="nav nav-pills">
                                <li class="nav-item">
                                    <a class="nav-link active" data-bs-toggle="pill" href="#SUV-Tab">SUVs</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="pill" href="#Commercial-Tab">CVs</a>
                                </li>
                ...
                <div class="services-content-div">
                    <div class="tab-content">
                        <div class="tab-pane active" id="SUV-Tab">
                            <div class="row">
                                <div class="col-md-4 mb-3 mb-sm-3 mb-md-5">
                                    <div class="services-card">
                                        <img src="{{ asset('images/services/suv1.jpg') }}" class="img-fluid" width="100%"/>
                                ...
                                <div class="col-md-4 mb-3 mb-sm-3 mb-md-5">
                                    <div class="services-card">
                                        <img src="{{ asset('images/services/suv2.jpg') }}" class="img-fluid" width="100%"/>
                                        <div class="card-content">
                                            <p>Fengon 580</p>
                                            <button class="btn btn-light">
                                                Download
                                ...
                                <div class="col-md-4 mb-3 mb-sm-3 mb-md-5">
                                    <div class="services-card">
                                        <img src="{{ asset('images/services/suv3.jpg') }}" class="img-fluid" width="100%"/>
                                        <div class="card-content">
                                            <p>Fengon 500</p>
                                            <button class="btn btn-light">
                                                Download
                                ...
                                <div class="col-md-4 mb-3 mb-sm-3 mb-md-5">
                                    <div class="services-card">
                                        <img src="{{ asset('images/services/suv4.jpg') }}" class="img-fluid" width="100%"/>
                                        <div class="card-content">
                                            <p>Fengon ix5</p>
                                            <button class="btn btn-light">
                                                Download
                                ...
                                <div class="col-md-4 mb-3 mb-sm-3 mb-md-5">
                                    <div class="services-card">
                                        <img src="{{ asset('images/services/suv5.jpg') }}" class="img-fluid" width="100%"/>
                                        <div class="card-content">
                                            <p>Fengon ix7</p>
                                            <button class="btn btn-light">
                                                Download
            ...
            <div id="map-collapseOne" class="accordion-collapse collapse" aria-labelledby="map-headingOne" data-bs-parent="#mapaccordion">
                <div class="accordion-body">
                    <div class="map-address-box">
                        <div class="mb-4">
                            <p>
                                <b>Address:</b> Hili Tower B, Mubarak Bin Mohamed St. Al Khalidiyah, AUH
                            </p>
                        ...
                        <div class="ma-contact-box mb-4">
                            ...
                            <p>
                                ...
                                <a class="text-white" href="tel:04 255 6392">02 553 0362</a>
                            </p>
                            <p>
